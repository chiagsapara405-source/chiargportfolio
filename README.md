...
1. Clone this repository:
   ```bash
   git clone https://github.com/your-username/chiargportfolio.git
   ```
...
- **Mobile**: <768px with mobile-optimized navigation
...
- **Optimized Images**: Compressed and web-formatted
